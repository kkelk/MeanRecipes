...
The \texttt{ingredients} field is a list of arrays of the form \verb![quantity, unit, name]!. The quantities returned are \emph{per person} --- that is, the recipe is written to serve one person. The \texttt{quantity} field may have the value \texttt{null}, indicating that no particular quantity of the ingredient is specified.
